...
osmcz.layers = function(map, baseLayers, overlays, controls) {
  ...
  var vodovky = L.tileLayer(
    'https://stamen-tiles-{s}.a.ssl.fastly.net/watercolor/{z}/{x}/{y}.jpg',
    {
      attribution:
        '&copy; CC-BY-SA <a href="https://openstreetmap.org/copyright">OSM</a>, imagery <a href="http://maps.stamen.com">Stamen Design</a>',
      maxZoom: 18,
      code: 's'
    }
  );
  ...
  var ortofoto = L.tileLayer.wms(
    'https://geoportal.cuzk.cz/WMS_ORTOFOTO_PUB/service.svc/get',
    {
  ...
  var ipr_last = L.tileLayer(
    'https://osm-{s}.zby.cz/tiles_ipr_last.php/{z}/{x}/{y}.png',
    {
      ...
      attribution:
        '&copy; <a href="http://www.iprpraha.cz/clanek/1305/ortofotomapy">IPR Praha</a>',
      code: 'i'
    }
  );

  var ipr_vege = L.tileLayer(
    'https://osm-{s}.zby.cz/tiles_ipr_vege.php/{z}/{x}/{y}.png',
    {
      minZoom: 12,
      maxZoom: 22,
      bounds: [[50.255, 14.113], [49.88, 14.8144]],
    ...
    if (event.layer == ortofoto || event.layer == vodovky) {
      setTimeout(function() {
        ...
        if (event.layer == ortofoto) {
          ...
          katastralniMapaOverlay.setParams(
            { layers: katastralniMapaOverlayLayersOrto },
            true
          );
        } else {
  ...
  var stravaAllOverlay = L.tileLayer(
  ...
  var turistikaOverlay = L.tileLayer(
  ...
  var lonviaHikingOverlay = L.tileLayer(
  ...
  var lonviaCyclingOverlay = L.tileLayer(
  ...
  var katastralniMapaOverlayLayers =
    ...
    katastralniMapaOverlayLayersOrto =
      'parcelni_cisla_i,obrazy_parcel_i,RST_KMD_I,hranice_parcel_i,DEF_BUDOVY,RST_KN_I,dalsi_p_mapy_i,prehledka_kat_prac,prehledka_kat_uz,prehledka_kraju-linie';
  var katastralniMapaOverlay = L.tileLayer.wms(
  ...
  var lpisOverlay = L.tileLayer.wms(
    osmcz.fakeHttps + 'eagri.cz/public/app/wms/plpis.fcgi',
    {
  ...
  var ruianAttr =
    '&copy; <a href="http://www.cuzk.cz">ČÚZK</a> (<a href="https://www.poloha.net">poloha.net</a>)';
